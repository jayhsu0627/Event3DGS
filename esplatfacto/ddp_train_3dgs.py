...
def create_3dgs(rank, args, camera_mgr, load_camera_mgr=True):
...
def ddp_train_3dgs(rank, args):
    ...
    start, models = create_3dgs(rank, args, camera_mgr)
...
def train():
    ...
    torch.multiprocessing.spawn(ddp_train_3dgs,
                                args=(args,),
